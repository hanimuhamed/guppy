      ...
      <div className="panel auth-panel" style={{ width: '800px', maxWidth: '90vw' }}>
        ...
        <div className="auth-form auth-form-split">
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
            ...
            <div style={{ marginTop: '24px', fontSize: '11px', textAlign: 'center', color: 'var(--text-muted)' }}>
              By continuing, you agree to our <Link to="/terms">Terms</Link> & <Link to="/privacy">Privacy Policy</Link>.
            </div>

            <div className="auth-footer" style={{ marginTop: 'auto', paddingTop: '24px' }}>
