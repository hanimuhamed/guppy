	...
	return (
		<footer className={`home-footer ${mobileOnly ? 'mobile-only' : ''}`}>
			<p style={{ color: 'var(--text-dimmed)', fontSize: '14px' }}>
				&copy; {current_year} <a href="https://github.com/hanimuhamed/guppy" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--text-dimmed)'}}>guppy</a>. All rights reserved.
			</p>
		</footer>
	)
}